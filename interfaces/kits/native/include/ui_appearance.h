...
#ifndef INTERFACE_KITS_NATIVE_INCLUDE_UI_APPEARANCE
#define INTERFACE_KITS_NATIVE_INCLUDE_UI_APPEARANCE
...
class __attribute__((visibility("default"))) UIAppearance {
public:
...
#endif // INTERFACE_KITS_NATIVE_INCLUDE_UI_APPEARANCE
