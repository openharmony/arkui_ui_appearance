...
napi_value JSSetFontWghtScaleSync(napi_env env, napi_callback_info info);
napi_value JSGetFontWghtScaleSync(napi_env env, napi_callback_info info);
} // namespace ArkUi::UiAppearance
} // namespace OHOS
