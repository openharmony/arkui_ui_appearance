...
#ifndef UI_APPEARANCE_ALARM_TIMER_H
#define UI_APPEARANCE_ALARM_TIMER_H

#include "time_service_client.h"

namespace OHOS {
namespace ArkUi::UiAppearance {
class AlarmTimer : public OHOS::MiscServices::ITimerInfo {
public:
    AlarmTimer() = default;
    virtual ~AlarmTimer() = default;
...
#endif // UI_APPEARANCE_ALARM_TIMER_H